...
//cgab, gefd
    ...
    len_type Altp[3] = {a4, c4,d4}; // m*k
    stride_type Astp[3] = { c4*d4,  d4, 1};
    ...
    tblis_tensor B;
    len_type Bltp[3] = {d4,b4, c4 };// n*k

    
//    stride_type Bstp[4] = {e4*f4*d4, f4*d4, d4,1};
    stride_type Bstp[3] = {c4*b4,c4,1};
...
//    tblis_tensor_mult(tblis_single, NULL, &A, "cgab", &B, "gefd", &C, "abcdef");
    ...
    tblis_tensor_mult(tblis_single, NULL, &A, "acd", &B, "dbc", &C, "ab");
//        tblis_tensor_mult(tblis_single, NULL, &A, "cgab", &B, "gefd", &C, "abcdef");
