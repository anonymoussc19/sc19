...
A[+a* C_range_e* C_range_c* C_range_f+e* C_range_c* C_range_f+c* C_range_f+f] * 
...
A = (double*)memalign(4096, sizeof(double) * A_range_a * A_range_e * A_range_c * A_range_f);
B = (double*)memalign(4096, sizeof(double) * B_range_f * B_range_b * B_range_e * B_range_d);
for(int i = 0; i < 1*A_range_a*A_range_e*A_range_c*A_range_f; i++){
A[i] = rand()%1000;
}
...
//Abuf = (double*)memalign(4096, sizeof(double) * A_range_a * A_range_e * A_range_c * A_range_f);
...
int A_stride_a = 1 * A_range_e * A_range_c * A_range_f;
int A_stride_e = 1 * A_range_c * A_range_f;
...
/* int Ia = Im / Fused_A_stride_a; */
/* int Ic = Im % Fused_A_stride_a; */
/* Abuf[A_pack_offset] = A[ +Ia*A_stride_a +Ie*A_stride_e +Ic*A_stride_c +If*A_stride_f]; */
/* } */
/* else{ */
/* int Ia = (Im - base_m_range) / Ext_A_stride_a; */
/* int Ic = (Im - base_m_range) % Ext_A_stride_a+ base_range_c; */
