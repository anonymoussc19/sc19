...
int main(int argc, char** argv)
{
   ...
   posix_memalign((void**) &dataA, 4096, sizeof(double) * ((size_t)td)*tf*tg*tb);
   posix_memalign((void**) &dataB, 4096, sizeof(double) * ((size_t)tg)*te*ta*tc);
   ...
   tcl::Tensor<double> A({tb,tg,tf,td}, dataA);
   tcl::Tensor<double> B({tc,ta,te,tg}, dataB);
