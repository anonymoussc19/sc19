...
A[+b* C_range_f* C_range_c* C_range_e+f* C_range_c* C_range_e+c* C_range_e+e] * 
B[+a* C_range_e* C_range_d* C_range_f+e* C_range_d* C_range_f+d* C_range_f+f]; 
}
...
A = (double*)memalign(4096, sizeof(double) * A_range_b * A_range_f * A_range_c * A_range_e);
B = (double*)memalign(4096, sizeof(double) * B_range_a * B_range_e * B_range_d * B_range_f);
for(int i = 0; i < 1*A_range_b*A_range_f*A_range_c*A_range_e; i++){
A[i] = rand()%1000;
}
for(int i = 0; i < 1*B_range_a*B_range_e*B_range_d*B_range_f; i++){
B[i] = rand()%1000;
}
...
//Abuf = (double*)memalign(4096, sizeof(double) * A_range_b * A_range_f * A_range_c * A_range_e);
...
int A_stride_b = 1 * A_range_f * A_range_c * A_range_e;
int A_stride_f = 1 * A_range_c * A_range_e;
int A_stride_c = 1 * A_range_e;
int A_stride_e = 1;
...
//Bbuf = (double*)memalign(4096, sizeof(double) * B_range_a * B_range_e * B_range_d * B_range_f);
...
int B_stride_a = 1 * B_range_e * B_range_d * B_range_f;
int B_stride_e = 1 * B_range_d * B_range_f;
int B_stride_d = 1 * B_range_f;
int B_stride_f = 1;
...
/* int Ib = Im / Fused_A_stride_b; */
/* int Ic = Im % Fused_A_stride_b; */
/* Abuf[A_pack_offset] = A[ +Ib*A_stride_b +If*A_stride_f +Ic*A_stride_c +Ie*A_stride_e]; */
/* } */
/* else{ */
/* int Ib = (Im - base_m_range) / Ext_A_stride_b; */
/* int Ic = (Im - base_m_range) % Ext_A_stride_b+ base_range_c; */
...
/* int Ia = In / Fused_B_stride_a; */
/* int Id = In % Fused_B_stride_a; */
/* Bbuf[B_pack_offset] = B[ +Ia*B_stride_a +Ie*B_stride_e +Id*B_stride_d +If*B_stride_f]; */
/* } */
/* else{ */
/* int Ia = (In - base_n_range) / Ext_B_stride_a; */
/* int Id = (In - base_n_range) % Ext_B_stride_a+ base_range_d; */
