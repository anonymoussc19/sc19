...
A[+c* C_range_e+e] * 
B[+e* C_range_b* C_range_a* C_range_d+b* C_range_a* C_range_d+a* C_range_d+d]; 
}
...
A = (double*)memalign(4096, sizeof(double) * A_range_c * A_range_e);
B = (double*)memalign(4096, sizeof(double) * B_range_e * B_range_b * B_range_a * B_range_d);
for(int i = 0; i < 1*A_range_c*A_range_e; i++){
A[i] = rand()%1000;
}
for(int i = 0; i < 1*B_range_e*B_range_b*B_range_a*B_range_d; i++){
B[i] = rand()%1000;
}
...
//Abuf = (double*)memalign(4096, sizeof(double) * A_range_c * A_range_e);
...
//Bbuf = (double*)memalign(4096, sizeof(double) * B_range_e * B_range_b * B_range_a * B_range_d);
...
int B_stride_e = 1 * B_range_b * B_range_a * B_range_d;
...
/* if(Im< base_m_range){ */
/* int Ic = Im / Fused_A_stride_c; */
/* Abuf[A_pack_offset] = A[ +Ic*A_stride_c +Ie*A_stride_e]; */
/* } */
/* else{ */
/* int Ic = (Im - base_m_range) / Ext_A_stride_c; */
/* Abuf[A_pack_offset] = A[ +Ic*A_stride_c +Ie*A_stride_e]; */
...
/* Bbuf[B_pack_offset+jj] = B[ +Ie*B_stride_e +Ib*B_stride_b +Ia*B_stride_a +(Id+jj)*B_stride_d]; */
/* } */
/* else{ */
/* int Ia = (In - base_n_range) / Ext_B_stride_a; */
/* int Ib = (In - base_n_range)  % Ext_B_stride_a / Ext_B_stride_b; */
/* int Id = (In - base_n_range) % Ext_B_stride_b+ base_range_d; */
/* Bbuf[B_pack_offset] = B[ +Ie*B_stride_e +Ib*B_stride_b +Ia*B_stride_a +Id*B_stride_d]; */
/* } */
/* // end pack body */
/* } */
/* } */
