...
A[+f* C_range_d+d] * 
B[+e* C_range_c* C_range_b* C_range_f* C_range_a+c* C_range_b* C_range_f* C_range_a+b* C_range_f* C_range_a+f* C_range_a+a]; 
}
...
int main(int argc, char** argv){
  ...
  int Tk4, Tk3, Tk2, Tk1, Tk0;
    ...
    Tk4 = C_range_f;
    Tm4 = A_range_d;
    Tn4 = B_range_a * B_range_b * B_range_c*B_range_e;
...
A = (double*)memalign(4096, sizeof(double) * A_range_f * A_range_d);
B = (double*)memalign(4096, sizeof(double) * B_range_e * B_range_c * B_range_b * B_range_f * B_range_a);
for(int i = 0; i < 1*A_range_f*A_range_d; i++){
A[i] = rand()%1000;
}
for(int i = 0; i < 1*B_range_e*B_range_c*B_range_b*B_range_f*B_range_a; i++){
B[i] = rand()%1000;
}
...
//Abuf = (double*)memalign(4096, sizeof(double) * A_range_f * A_range_d);
Abuf = (double*)memalign(4096, sizeof(double) * Tm3*Tk3);
int ext_range_d = A_range_d % Tm0;
int base_range_d = A_range_d - ext_range_d;
int base_m_range = base_range_d;
unsigned long long *Ascatter = (unsigned long long*)memalign(4096, sizeof(unsigned long long)*A_range_d);

int A_stride_f = 1 * A_range_d;
int A_stride_d = 1;
...
int Id = Im / Fused_A_stride_d;
Ascatter[Im] = +Id*C_range_e;
}
for(int Im=base_m_range; Im < Tm4;Im++){
int Id = (Im - base_m_range) / Ext_A_stride_d;
Ascatter[Im] = +Id*C_range_e;
}

//Bbuf = (double*)memalign(4096, sizeof(double) * B_range_e * B_range_c * B_range_b * B_range_f * B_range_a);
...
int base_n_range = base_range_e * B_range_c * B_range_b * B_range_a;
unsigned long long *Bscatter = (unsigned long long*)memalign(4096, sizeof(unsigned long long)*B_range_a*B_range_b*B_range_c*B_range_e);

int B_stride_e = 1 * B_range_c * B_range_b * B_range_f * B_range_a;
int B_stride_c = 1 * B_range_b * B_range_f * B_range_a;
int B_stride_b = 1 * B_range_f * B_range_a;
int B_stride_f = 1 * B_range_a;
int B_stride_a = 1;


int Fused_B_stride_b = 1 * B_range_c * B_range_a* base_range_e;
int Fused_B_stride_c = 1 * B_range_a *  base_range_e;
int Fused_B_stride_a = 1  * base_range_e;
int Fused_B_stride_e = 1;


int Ext_B_stride_b = 1 * B_range_a  * B_range_c * ext_range_e;
int Ext_B_stride_c = 1 * B_range_a *ext_range_e;
int Ext_B_stride_a = 1 *  ext_range_e;
...
int Ie = In % Fused_B_stride_a;
Bscatter[In] = +Ia*C_range_b*C_range_c*C_range_d*C_range_e+Ib*C_range_c*C_range_d*C_range_e+Ic*C_range_d*C_range_e+Ie;
}
...
int Ie = (In - base_n_range) % Ext_B_stride_c+ base_range_e;
Bscatter[In] = +Ia*C_range_b*C_range_c*C_range_d*C_range_e+Ib*C_range_c*C_range_d*C_range_e+Ic*C_range_d*C_range_e+Ie;
}
...
/* if(Im< base_m_range){ */
/* int Id = Im / Fused_A_stride_d; */
/* Abuf[A_pack_offset] = A[ +If*A_stride_f +Id*A_stride_d]; */
/* } */
/* else{ */
/* int Id = (Im - base_m_range) / Ext_A_stride_d; */
/* Abuf[A_pack_offset] = A[ +If*A_stride_f +Id*A_stride_d]; */
...
/* int Ic = In % Fused_B_stride_b / Fused_B_stride_c; */
/* int Ie = In % Fused_B_stride_c; */
/* for(int jj = 0; jj< 8;jj++) */
/* Bbuf[B_pack_offset+jj] = B[ +(Ie+jj)*B_stride_e +Ic*B_stride_c +Ib*B_stride_b +If*B_stride_f +Ia*B_stride_a]; */
/* } */
/* else{ */
...
/* int Ic = (In - base_n_range)  % Ext_B_stride_b / Ext_B_stride_c; */
/* int Ie = (In - base_n_range) % Ext_B_stride_c+ base_range_e; */
/* Bbuf[B_pack_offset] = B[ +Ie*B_stride_e +Ic*B_stride_c +Ib*B_stride_b +If*B_stride_f +Ia*B_stride_a]; */
/* } */
/* // end pack body */
/* } */
/* } */
...
/* int add_Ia1_pckoff = (Fused_B_stride_a %Tn1)* MIN(Tk1, Tk4-k2-k3-k4) */
...
/* int add_Ia2_pckoff = (2*Fused_B_stride_a %Tn1)* MIN(Tk1, Tk4-k2-k3-k4) */
...
/* int add_Ia3_pckoff = (3*Fused_B_stride_a %Tn1)* MIN(Tk1, Tk4-k2-k3-k4) */
...
/* int add_Ia4_pckoff = (4*Fused_B_stride_a %Tn1)* MIN(Tk1, Tk4-k2-k3-k4) */
...
/* int add_Ia5_pckoff = (5*Fused_B_stride_a %Tn1)* MIN(Tk1, Tk4-k2-k3-k4) */
...
/* int add_Ia6_pckoff = (6*Fused_B_stride_a %Tn1)* MIN(Tk1, Tk4-k2-k3-k4) */
...
/* int add_Ia7_pckoff = (7*Fused_B_stride_a %Tn1)* MIN(Tk1, Tk4-k2-k3-k4) */
...
/* {Bbuf[B_pack_offset+jj] = B[ +(Ie+jj)*B_stride_e +Ic*B_stride_c +Ib*B_stride_b +If*B_stride_f +Ia*B_stride_a];} */
    ...
    WS_MOVE_M4xF64_TO_R4xF64((double* ) &B[ +(Ie+0)*B_stride_e +Ic*B_stride_c +Ib*B_stride_b +If*B_stride_f +Ia*B_stride_a], mymm0 );
    WS_MOVE_M4xF64_TO_R4xF64((double* ) &B[ +(Ie+1)*B_stride_e +Ic*B_stride_c +Ib*B_stride_b +If*B_stride_f +Ia*B_stride_a], mymm1 );
    WS_MOVE_M4xF64_TO_R4xF64((double* ) &B[ +(Ie+2)*B_stride_e +Ic*B_stride_c +Ib*B_stride_b +If*B_stride_f +Ia*B_stride_a], mymm2 );
    WS_MOVE_M4xF64_TO_R4xF64((double* ) &B[ +(Ie+3)*B_stride_e +Ic*B_stride_c +Ib*B_stride_b +If*B_stride_f +Ia*B_stride_a], mymm3 );
    WS_MOVE_M4xF64_TO_R4xF64((double* ) &B[ +(Ie+4)*B_stride_e +Ic*B_stride_c +Ib*B_stride_b +If*B_stride_f +Ia*B_stride_a], mymm4 );
    WS_MOVE_M4xF64_TO_R4xF64((double* ) &B[ +(Ie+5)*B_stride_e +Ic*B_stride_c +Ib*B_stride_b +If*B_stride_f +Ia*B_stride_a], mymm5 );
    WS_MOVE_M4xF64_TO_R4xF64((double* ) &B[ +(Ie+6)*B_stride_e +Ic*B_stride_c +Ib*B_stride_b +If*B_stride_f +Ia*B_stride_a], mymm6 );
    WS_MOVE_M4xF64_TO_R4xF64((double* ) &B[ +(Ie+7)*B_stride_e +Ic*B_stride_c +Ib*B_stride_b +If*B_stride_f +Ia*B_stride_a], mymm7 );
 ...
 */
    ...
    WS_MOVE_M4xF64_TO_R4xF64((double* ) &B[ +(Ie+0)*B_stride_e +Ic*B_stride_c +Ib*B_stride_b +If*B_stride_f +(Ia+4)*B_stride_a], mymm0 );
    WS_MOVE_M4xF64_TO_R4xF64((double* ) &B[ +(Ie+1)*B_stride_e +Ic*B_stride_c +Ib*B_stride_b +If*B_stride_f +(Ia+4)*B_stride_a], mymm1 );
    WS_MOVE_M4xF64_TO_R4xF64((double* ) &B[ +(Ie+2)*B_stride_e +Ic*B_stride_c +Ib*B_stride_b +If*B_stride_f +(Ia+4)*B_stride_a], mymm2 );
    WS_MOVE_M4xF64_TO_R4xF64((double* ) &B[ +(Ie+3)*B_stride_e +Ic*B_stride_c +Ib*B_stride_b +If*B_stride_f +(Ia+4)*B_stride_a], mymm3 );
    WS_MOVE_M4xF64_TO_R4xF64((double* ) &B[ +(Ie+4)*B_stride_e +Ic*B_stride_c +Ib*B_stride_b +If*B_stride_f +(Ia+4)*B_stride_a], mymm4 );
    WS_MOVE_M4xF64_TO_R4xF64((double* ) &B[ +(Ie+5)*B_stride_e +Ic*B_stride_c +Ib*B_stride_b +If*B_stride_f +(Ia+4)*B_stride_a], mymm5 );
    WS_MOVE_M4xF64_TO_R4xF64((double* ) &B[ +(Ie+6)*B_stride_e +Ic*B_stride_c +Ib*B_stride_b +If*B_stride_f +(Ia+4)*B_stride_a], mymm6 );
    WS_MOVE_M4xF64_TO_R4xF64((double* ) &B[ +(Ie+7)*B_stride_e +Ic*B_stride_c +Ib*B_stride_b +If*B_stride_f +(Ia+4)*B_stride_a], mymm7 );
...
int Ic = (In - base_n_range)  % Ext_B_stride_b / Ext_B_stride_c;
int Ia = (In - base_n_range)  % Ext_B_stride_c / Ext_B_stride_a;
int Ie = (In - base_n_range) % Ext_B_stride_a+ base_range_e;
for(int k1 = 0; k1 < Tk1; k1 += Tk0)
{
if(+k1+k2+k3+k4>=Tk4)break;
 int If = k1+k2+k3+k4;
...
bli_dgemm_haswell_asm_6x8(use_k,  &alpha, Abuf+ A_pack_offset, Bbuf+B_pack_offset, &beta, C+ Ascatter[Im] + Bscatter[In], 1*C_range_e, 1, NULL, NULL);
}
