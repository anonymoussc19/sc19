...
A[+e* C_range_a* C_range_f* C_range_b+a* C_range_f* C_range_b+f* C_range_b+b] * 
B[+f* C_range_d* C_range_e* C_range_c+d* C_range_e* C_range_c+e* C_range_c+c]; 
}
...
A = (double*)memalign(4096, sizeof(double) * A_range_e * A_range_a * A_range_f * A_range_b);
B = (double*)memalign(4096, sizeof(double) * B_range_f * B_range_d * B_range_e * B_range_c);
for(int i = 0; i < 1*A_range_e*A_range_a*A_range_f*A_range_b; i++){
A[i] = rand()%1000;
}
for(int i = 0; i < 1*B_range_f*B_range_d*B_range_e*B_range_c; i++){
B[i] = rand()%1000;
}
...
//Abuf = (double*)memalign(4096, sizeof(double) * A_range_e * A_range_a * A_range_f * A_range_b);
...
int A_stride_e = 1 * A_range_a * A_range_f * A_range_b;
int A_stride_a = 1 * A_range_f * A_range_b;
...
//Bbuf = (double*)memalign(4096, sizeof(double) * B_range_f * B_range_d * B_range_e * B_range_c);
...
int B_stride_f = 1 * B_range_d * B_range_e * B_range_c;
int B_stride_d = 1 * B_range_e * B_range_c;
int B_stride_e = 1 * B_range_c;
int B_stride_c = 1;
...
/* int Ia = Im / Fused_A_stride_a; */
/* int Ib = Im % Fused_A_stride_a; */
/* Abuf[A_pack_offset] = A[ +Ie*A_stride_e +Ia*A_stride_a +If*A_stride_f +Ib*A_stride_b]; */
/* } */
/* else{ */
/* int Ia = (Im - base_m_range) / Ext_A_stride_a; */
/* int Ib = (Im - base_m_range) % Ext_A_stride_a+ base_range_b; */
...
/* int Ic = In / Fused_B_stride_c; */
/* int Id = In % Fused_B_stride_c; */
/* Bbuf[B_pack_offset] = B[ +If*B_stride_f +Id*B_stride_d +Ie*B_stride_e +Ic*B_stride_c]; */
/* } */
/* else{ */
/* int Ic = (In - base_n_range) / Ext_B_stride_c; */
/* int Id = (In - base_n_range) % Ext_B_stride_c+ base_range_d; */
