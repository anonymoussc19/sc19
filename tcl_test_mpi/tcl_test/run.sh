...
export HPTT_ROOT=/home/li23/majorrev/tclblis/hptt
export TCL_ROOT=/home/li23/majorrev/tclblis/tcl
export BLIS_ROOT=/home/li23/majorrev/tclblis/blis
#export HPTT_ROOT= #YOUR HPTT INSTALLATION DIR
#export TCL_ROOT= #YOUR TCL INSTALLATION DIR
export LD_LIBRARY_PATH=$HPTT_ROOT/lib:$TCL_ROOT/lib:$BLIS_ROOT/lib/haswell:$LD_LIBRARY_PATH:

for i in $( find . -name "*.cpp" ); do
    echo  "$i, "
    echo " 0000000 "
    mpicxx $i -O0 -I $TCL_ROOT/include/ -g --std=c++11   -L $HPTT_ROOT/lib -lhptt -L $TCL_ROOT/lib/ -ltcl   -fopenmp   -lpthread -lm -ldl  -L $BLIS_ROOT/lib/haswell -lblis
