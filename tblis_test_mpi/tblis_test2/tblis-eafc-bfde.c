...
A[+e* C_range_a* C_range_c* C_range_f+a* C_range_c* C_range_f+f* C_range_c+c] * 
...
//cgab, gefd
    ...
    stride_type Astp[4] = { a4*c4*f4, c4*f4,  c4, 1};
...
start = omp_get_wtime();
    ...
    tblis_tensor_mult(tblis_single, NULL, &A, "eafc", &B, "bfde", &C, "abcd");
