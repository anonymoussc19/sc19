...
A[+a* C_range_e* C_range_c* C_range_f+e* C_range_c* C_range_f+f* C_range_c+c] * 
...
//cgab, gefd
    ...
    stride_type Astp[4] = { e4*c4*f4, c4*f4,  c4, 1};
    ...
    tblis_tensor B;
    len_type Bltp[4] = {f4,b4,e4,d4 };// n*k

    
//    stride_type Bstp[4] = {e4*f4*d4, f4*d4, d4,1};
    stride_type Bstp[4] = {b4*e4*d4, e4*d4,d4,1};
...
start = omp_get_wtime();
    ...
    tblis_tensor_mult(tblis_single, NULL, &A, "aefc", &B, "fbed", &C, "abcd");
