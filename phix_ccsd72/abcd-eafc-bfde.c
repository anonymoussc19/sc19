...
A[+e* C_range_a* C_range_f* C_range_c+a* C_range_f* C_range_c+f* C_range_c+c] * 
B[+b* C_range_f* C_range_d* C_range_e+f* C_range_d* C_range_e+d* C_range_e+e]; 
}
...
A = (double*)memalign(4096, sizeof(double) * A_range_e * A_range_a * A_range_f * A_range_c);
B = (double*)memalign(4096, sizeof(double) * B_range_b * B_range_f * B_range_d * B_range_e);
for(int i = 0; i < 1*A_range_e*A_range_a*A_range_f*A_range_c; i++){
A[i] = rand()%1000;
}
for(int i = 0; i < 1*B_range_b*B_range_f*B_range_d*B_range_e; i++){
B[i] = rand()%1000;
}
...
//Abuf = (double*)memalign(4096, sizeof(double) * A_range_e * A_range_a * A_range_f * A_range_c);
...
int A_stride_e = 1 * A_range_a * A_range_f * A_range_c;
int A_stride_a = 1 * A_range_f * A_range_c;
...
//Bbuf = (double*)memalign(4096, sizeof(double) * B_range_b * B_range_f * B_range_d * B_range_e);
...
int B_stride_b = 1 * B_range_f * B_range_d * B_range_e;
int B_stride_f = 1 * B_range_d * B_range_e;
int B_stride_d = 1 * B_range_e;
int B_stride_e = 1;
...
/* int Ia = Im / Fused_A_stride_a; */
/* int Ic = Im % Fused_A_stride_a; */
/* Abuf[A_pack_offset] = A[ +Ie*A_stride_e +Ia*A_stride_a +If*A_stride_f +Ic*A_stride_c]; */
/* } */
/* else{ */
/* int Ia = (Im - base_m_range) / Ext_A_stride_a; */
/* int Ic = (Im - base_m_range) % Ext_A_stride_a+ base_range_c; */
...
/* int Ib = In / Fused_B_stride_b; */
/* int Id = In % Fused_B_stride_b; */
/* Bbuf[B_pack_offset] = B[ +Ib*B_stride_b +If*B_stride_f +Id*B_stride_d +Ie*B_stride_e]; */
/* } */
/* else{ */
/* int Ib = (In - base_n_range) / Ext_B_stride_b; */
/* int Id = (In - base_n_range) % Ext_B_stride_b+ base_range_d; */
